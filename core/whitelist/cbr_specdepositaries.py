...
def data_unit_iterator() -> BaseDataUnit:
    excel_table_link = "https://www.cbr.ru/vfs/finmarkets/files/supervision/list_specdepositaries.xlsx"
    ...
    for index, row in df.iterrows():
        ...
        try:
            data_unit = BaseDataUnit(
                type='white_list',
                name=row.iloc[1],
                name_full=row.iloc[2],
                cbr_license_id=row.iloc[5],
                cbr_license_issue_date=row.iloc[6],
